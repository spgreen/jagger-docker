...
$config['site_logo'] = getenv('RR3_LOGO') ? getenv('RR3_LOGO') : 'logo-default.png';

$config['syncpass'] = getenv('RR3_SYNC_PASS');

$config['support_mailto'] = getenv('RR3_SUPPORT_EMAIL');
...
$config['Shibboleth']['enabled'] = FALSE;
...
$config['fedmetadataidprefix'] = getenv('RR3_METADATA_PREFIX') ? getenv('RR3_METADATA_PREFIX') : 'prefix-';
$config['fedexportmetadataidprefix'] = $config['fedmetadataidprefix'].'export-';
$config['circlemetadataidprefix'] = $config['fedmetadataidprefix'].'circle-';
