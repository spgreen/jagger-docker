...
|
*/
$config['base_url']	= getenv('RR3_BASE_URL').'/rr3/';
...
|
*/
$config['encryption_key'] = getenv('RR3_ENCRYPTION_KEY');
...
$config['sess_save_path'] = (getenv('MEMCACHED_HOST')).':'.(getenv('MEMCACHED_PORT'));
