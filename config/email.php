...
$config['smtp_host'] = getenv('SMTP_SERVER') ? getenv('SMTP_SERVER') : '127.0.0.1' ;
...
$config['smtp_user'] = getenv('SMTP_USERNAME') ? getenv('SMTP_USERNAME') : '';
$config['smtp_pass'] = getenv('SMTP_PASSWORD') ? getenv('SMTP_PASSWORD') : '';
