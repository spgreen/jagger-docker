...
$config['mail_from'] = 'no-reply@localhost';
$config['fake_mail_from'] = 'no-reply@localhost';
$config['reply_to'] = 'root@localhost';
$config['mail_subject_suffix'] = '[LOCALHOST-RR3]';
